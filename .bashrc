...
alias init='apt update -y ; apt update -y ; apt install -y sudo vim neofetch nmap dnsutils sshfs wget curl zip unzip iptables git htop mlocate ; apt upgrade -y ; reboot'
